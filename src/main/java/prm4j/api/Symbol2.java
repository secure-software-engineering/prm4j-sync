...
public class Symbol2<L, P1, P2> extends Symbol<L> {

    private final Parameter<P1> param1;
    private final Parameter<P2> param2;

    Symbol2(Alphabet<L> alphabet, int uniqueId, L uniqueName, Parameter<P1> param1, Parameter<P2> param2) {
    ...
    public Symbol2(Alphabet<L> alphabet, int uniqueId, String uniqueName,
			Parameter<P1> param1, Parameter<P2> param2) {
    	super(alphabet, uniqueId, uniqueName);
    	this.param1 = param1;
    	this.param2 = param2;
    	setParameters(param1, param2);
