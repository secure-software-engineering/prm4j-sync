...
public class DefaultParametricMonitor_ab_a_Test extends AbstractDefaultParametricMonitorTest {
	...
	public final Symbol2<AbstractionAndSymbol,String, String> e1 = alphabet.createSymbol2("e1", p1, p2);
	public final Symbol1<AbstractionAndSymbol,String> e2 = alphabet.createSymbol1("e1", p1);
    ...
    @Test
    public void ab_a_match() throws Exception {
	// exercise
	pm.processEvent(fsm.e1.createEvent(a1, b1));
	pm.processEvent(fsm.e2.createEvent(a1));
    ...
    @Test
    public void a1_a1b1_a1_nomatch() throws Exception {
	// exercise
	pm.processEvent(fsm.e2.createEvent(a1));
	pm.processEvent(fsm.e1.createEvent(a1, b1));
	pm.processEvent(fsm.e2.createEvent(a1));
    ...
    @Test
    public void a2_a1b1_a1_match() throws Exception {
	// exercise
	pm.processEvent(fsm.e2.createEvent(a2));
	pm.processEvent(fsm.e1.createEvent(a1, b1));
	pm.processEvent(fsm.e2.createEvent(a1));
    ...
    @Test
    public void a1b2_a1b1_a1_2matches() throws Exception {
	// exercise
	pm.processEvent(fsm.e1.createEvent(a1, b2));
	pm.processEvent(fsm.e1.createEvent(a1, b1));
	pm.processEvent(fsm.e2.createEvent(a1));

	// verify
	assertEquals(2, fsm.matchHandler.getHandledMatches().size());
    }

    @Test
    public void a2b1_a1b1_a1_match() throws Exception {
	// exercise
	pm.processEvent(fsm.e1.createEvent(a2, b1));
	pm.processEvent(fsm.e1.createEvent(a1, b1));
	pm.processEvent(fsm.e2.createEvent(a1));
    ...
    @Test
    public void a2b1_a1b1_a1_a2_2matches() throws Exception {
	// exercise
	pm.processEvent(fsm.e1.createEvent(a2, b1));
	pm.processEvent(fsm.e1.createEvent(a1, b1));
	pm.processEvent(fsm.e2.createEvent(a1));
